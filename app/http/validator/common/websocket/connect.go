...
type Connect struct {
    ...
    UserId   float64 `form:"user_id" json:"user_id"`
    HomeId   float64 `form:"home_id" json:"home_id" binding:"required,min=1"`
    UserType string  `form:"user_type" json:"user_type" binding:"required,min=1"`
}
